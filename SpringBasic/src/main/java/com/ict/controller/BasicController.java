...
// /goB로 접속했을때 실행되는 b.jsp 창이 열리도록 아래에 세팅해주세요.
	...
	// 성적 결과 페이지 접근 로직
		...
		public String getRate(@PathVariable int money, Model model) {
			final double USD =1209.80; //환율을 상수처리해도 좋다.
			
			double result = (money/USD);
	...
	// 만약 주소와 매칭된 메서드의 리턴 자료형을 String이 아닌 void로 처리하는 경우
	...
	// 주소와 파일명이 일치한다면 써주셔도 되지만
       ...
       public void goTest()	{
		...
		public String postUserInfo(UserVO userVO,Model model) {
			...
			return "user";//user.jsp에서 볼수 있도록 EL문법을 사용해주세요.
		}
